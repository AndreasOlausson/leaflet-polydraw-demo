...
// node_modules/leaflet-polydraw/dist/polydraw.es.js
...
var kinks$1 = false;
var modes = { "draw": true, "subtract": true, "deleteAll": true, "p2p": true, "attachElbow": true, "dragElbow": true, "dragPolygons": true, "edgeDeletion": true };
var dragPolygons = { "opacity": 0.7, "dragCursor": "move", "hoverCursor": "grab", "markerBehavior": "hide", "markerAnimationDuration": 200, "modifierSubtract": { "keys": { "windows": "ctrlKey", "mac": "metaKey", "linux": "ctrlKey" }, "hideMarkersOnDrag": true } };
var edgeDeletion = { "keys": { "windows": "ctrlKey", "mac": "metaKey", "linux": "ctrlKey" }, "minVertices": 3 };
var markers = { "deleteMarker": true, "infoMarker": true, "menuMarker": true, "coordsTitle": true, "zIndexOffset": 0, "markerIcon": { "styleClasses": ["polygon-marker"], "zIndexOffset": null }, "holeIcon": { "styleClasses": ["polygon-marker", "hole"], "zIndexOffset": null }, "markerInfoIcon": { "position": 3, "showArea": true, "showPerimeter": true, "useMetrics": true, "usePerimeterMinValue": false, "areaLabel": "Area", "perimeterLabel": "Perimeter", "values": { "min": { "metric": "50", "imperial": "100" }, "unknown": { "metric": "-", "imperial": "-" } }, "units": { "unknownUnit": "", "metric": { "onlyMetrics": true, "perimeter": { "m": "m", "km": "km" }, "area": { "m2": "m²", "km2": "km²", "daa": "daa", "ha": "ha" } }, "imperial": { "perimeter": { "feet": "ft", "yards": "yd", "miles": "mi" }, "area": { "feet2": "ft²", "yards2": "yd²", "acres": "ac", "miles2": "mi²" } } }, "styleClasses": ["polygon-marker", "info"], "zIndexOffset": 1e4 }, "markerMenuIcon": { "position": 7, "styleClasses": ["polygon-marker", "menu"], "zIndexOffset": 1e4 }, "markerDeleteIcon": { "position": 5, "styleClasses": ["polygon-marker", "delete"], "zIndexOffset": 1e4 }, "holeMarkers": { "menuMarker": false, "deleteMarker": true, "infoMarker": false }, "visualOptimization": { "sharpAngleThreshold": 30, "thresholdBoundingBox": 0.05, "thresholdDistance": 0.05, "useDistance": true, "useBoundingBox": false, "useAngles": false } };
var polyLineOptions = { "opacity": 1, "smoothFactor": 0, "noClip": true, "clickable": false, "weight": 2 };
var subtractLineOptions = { "opacity": 1, "smoothFactor": 0, "noClip": true, "clickable": false, "weight": 2 };
var polygonOptions = { "smoothFactor": 0.3, "noClip": true };
var holeOptions = { "weight": 2, "opacity": 1, "fillOpacity": 0.5 };
var polygonCreation = { "method": "concaveman", "simplification": { "mode": "simple", "tolerance": 1e-5, "highQuality": false } };
var simplification = { "simplifyTolerance": { "tolerance": 1e-4, "highQuality": false, "mutate": false }, "dynamicMode": { "fractionGuard": 0.9, "multiplier": 2 } };
var menuOperations = { "simplify": { "processHoles": true }, "doubleElbows": { "processHoles": true }, "bbox": { "processHoles": true } };
var boundingBox = { "addMidPointMarkers": true };
var bezier$1 = { "resolution": 1e4, "sharpness": 0.75 };
var colors = { "dragPolygons": { "subtract": "#D9460F" }, "p2p": { "closingMarker": "#4CAF50" }, "edgeHover": "#7a9441", "edgeDeletion": { "hover": "#D9460F" }, "polyline": "#50622b", "subtractLine": "#D9460F", "polygon": { "border": "#50622b", "fill": "#b4cd8a" }, "hole": { "border": "#aa0000", "fill": "#ffcccc" }, "styles": { "controlButton": { "backgroundColor": "#fff", "color": "#000" }, "controlButtonHover": { "backgroundColor": "#f4f4f4" }, "controlButtonActive": { "backgroundColor": "rgb(128, 218, 255)", "color": "#fff" }, "indicatorActive": { "backgroundColor": "#ffcc00" }, "p2pMarker": { "backgroundColor": "#fff", "borderColor": "#50622b" } } };
var defaultConfig = {
  mergePolygons,
  kinks: kinks$1,
  modes,
...
var TinyQueue$1 = class TinyQueue {
...
var tinyqueue = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: TinyQueue$1
}, Symbol.toStringTag, { value: "Module" }));
var require$$1 = getAugmentedNamespace(tinyqueue);
...
function requirePointInPolygon() {
  ...
  pointInPolygon$1.exports = function pointInPolygon2(point2, vs, start, end) {
...
var concaveman = getDefaultExportFromCjs(concavemanExports);
...
function runCheck(eventQueue, ignoreSelfIntersections) {
  ...
  const outQueue = new TinyQueue2([], checkWhichSegmentHasRightEndpointFirst);
...
function sweeplineIntersections$1(geojson, ignoreSelfIntersections) {
  const eventQueue = new TinyQueue2([], checkWhichEventIsLeft);
...
var turf_intersect_default = intersect$1;
...
var turf_explode_default = explode$1;
...
var jsts = getDefaultExportFromCjs(jsts_minExports);
function adder() {
  return new Adder();
}
function Adder() {
...
function clipCircle(radius, delta) {
  ...
  function intersect2(a, b, two) {
    ...
    var delta2 = lambda1 - lambda0, polar = abs(delta2 - pi) < epsilon$1, meridian = polar || delta2 < epsilon$1;
    if (!polar && phi1 < phi0) z = phi0, phi0 = phi1, phi1 = z;
    if (meridian ? polar ? phi0 + phi1 > 0 ^ q[1] < (abs(q[0] - lambda0) < epsilon$1 ? phi0 : phi1) : phi0 <= q[1] && q[1] <= phi1 : delta2 > pi ^ (lambda0 <= q[0] && q[0] <= lambda1)) {
...
function resample$1(project, delta2) {
  function resampleLineTo(x02, y02, lambda0, a0, b0, c0, x12, y12, lambda1, a1, b1, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a = a0 + a1, b = b0 + b1, c = c0 + c1, m = sqrt(a * a + b * b + c * c), phi2 = asin(c /= m), lambda2 = abs(abs(c) - 1) < epsilon$1 || abs(lambda0 - lambda1) < epsilon$1 ? (lambda0 + lambda1) / 2 : atan2(b, a), p = project(lambda2, phi2), x2 = p[0], y2 = p[1], dx2 = x2 - x02, dy2 = y2 - y02, dz = dy * dx2 - dx * dy2;
...
function isPointOnLineSegment$1(start, end, point2) {
  var x = point2[0], y = point2[1];
...
var TurfHelper = class {
  ...
  getSimplified(polygon2, dynamicTolerance = false) {
    ...
    if (simplificationMode === "simple") {
      ...
      const simplified = turf_simplify_default(polygon2, tolerance);
      return simplified;
      ...
      return turf_simplify_default(polygon2, tolerance);
    }
  }
  ...
  getKinks(feature2) {
    try {
      ...
      if (hasHoles) {
        ...
        const unkink = turf_unkink_polygon_default(cleanedFeature);
        const coordinates = [];
  ...
  polygonIntersect(polygon2, latlngs) {
    try {
      ...
      try {
        const points1 = turf_explode_default(polygon2);
        const points2 = turf_explode_default(latlngs);
        for (const point2 of points2.features) {
          if (turf_boolean_point_in_polygon_default(point2, polygon2)) {
            return true;
          }
        }
        for (const point2 of points1.features) {
          if (turf_boolean_point_in_polygon_default(point2, latlngs)) {
            return true;
          }
        }
      } catch (error) {
  ...
  toPointFeature(pt) {
    var _a2, _b2;
    if ((pt == null ? void 0 : pt.type) === "Feature" && ((_a2 = pt.geometry) == null ? void 0 : _a2.type) === "Point") {
      return pt;
    }
  ...
  isPointInsidePolygon(pt, polygon2) {
    try {
      ...
      return turf_boolean_point_in_polygon_default(pointFeature, polygon2);
    } catch (error) {
      return false;
    }
  }
  ...
  getNearestPointIndex(targetPoint, points) {
    const index = turf_nearest_point_default(targetPoint, points).properties.featureIndex;
    return index;
  }
  /**
  ...
  getPolygonPerimeter(poly) {
    const polygonLength = turf_length_default(poly, { units: "kilometers" });
    return polygonLength;
  }
  getCenterOfMass(feature2) {
    return turf_center_of_mass_default(feature2);
  }
  ...
  getBezierMultiPolygon(polygonArray) {
    const line = turf_polygon_to_line_default(this.getMultiPolygon(polygonArray));
    line.features[0].geometry.coordinates.push(
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      line.features[0].geometry.coordinates[0]
    );
    const bezierLine = turf_bezier_spline_default(line.features[0], {
      resolution: this.config.bezier.resolution,
      sharpness: this.config.bezier.sharpness
    });
    const bezierPoly = turf_line_to_polygon_default(bezierLine);
    return bezierPoly;
  }
  /**
    ...
    try {
      if (feature2.geometry.type === "Polygon") {
        ...
        if (outerHasKinks || outerRingIntersectsHoles) {
          ...
          const unkink = turf_unkink_polygon_default(outerPolygon);
          const splitPolygons = [];
  ...
  handleCompleteHoleTraversal(outerPolygon, _holes) {
    try {
      ...
      const unkink = turf_unkink_polygon_default(solidPolygon);
...
var PolygonInformationService = class {
...
var PolygonGeometryManager = class {
  constructor(dependencies) {
    __publicField(this, "turfHelper");
    __publicField(this, "config");
    this.turfHelper = dependencies.turfHelper;
...
var PolygonInteractionManager = class {
    ...
    latlngs.forEach((latlng, i) => {
      ...
      if (i === menuMarkerIdx && this.config.markers.menuMarker) {
        ...
        marker.on("popupopen", (e) => {
          const popup2 = e.popup;
          const popupContent = popup2.getElement();
...
var PolygonMutationManager = class {
  constructor(dependencies) {
    __publicField(this, "turfHelper");
    __publicField(this, "map");
    __publicField(this, "config");
...
var Polydraw = class extends L.Control {
  constructor(options) {
    super(options);
    __publicField(this, "map");
    __publicField(this, "tracer");
...
//# sourceMappingURL=leaflet-polydraw.js.map
